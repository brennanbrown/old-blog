...
layout: post
title: Goal Success
subtitle: Getting back on your horse, no matter how many times you’ve fallen off.
date: '2020-02-16T11:15:33.494Z'
author: Brennan K. Brown
permalink: "/goal-success/"
image: https://cdn-images-1.medium.com/max/2560/1*DTAD7WCmm2MF_MYenGbDcw.jpeg
image_caption: Flight procedure checklists, mission data cards, and T-6 Texan II models
  | Source
canonical_url: https://medium.com/@brennanbrown/5-good-goals-ideas-and-why-86caddb33e70
medium_id: 86caddb33e70
---

### Project Journal Bar

In [my last post](https://medium.com/@brennanbrown/goal-failure-bc3a39a0f418), I talked about the struggles and failures I’ve faced the past few years. I’ve been thinking about how to tackle my short-comings and problems to solve a single, relatively-simple issue that’s plagued me nearly my entire life: consistency in my work ethic.

There needs to be more hand-holding involved — change does not come quickly nor simply. So I’ve devised an entirely new project for myself: [**Journal Bar**](https://journal.kim). This is a new blog that I’ve made where I’m going to be posting about the progress I’ve been making weekly. The (very simple) ingenious part is that I’m [tracking the posts](https://www.beeminder.com/brennanbrown/journalbar) I write.
...
It’s easy to argue that one particular brand or program is superior in some fashion, but in the lightspeed world of venture capitalism, these companies and start-ups can [disappear in an instance](https://ourincrediblejourney.tumblr.com/).

Don’t allow yourself to get too comfortable using one particular thing. In fact, you should ideally using something that’s [completely free, doesn’t require internet access, and is stable](https://alternativeto.net/). If something were to happen to the exclusive product you’re using, it might take a toll on your morale, or even worse, you could lose data.
