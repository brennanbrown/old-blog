...
layout: post
title: Afterwards
subtitle: Death from a UX Standpoint
date: '2016-04-21T23:41:45.270Z'
...
- Technology
- UX
image: https://cdn-images-1.medium.com/max/2560/1*ovS5DaMRUWt1-4Aj7xX_OQ.jpeg
image_caption: Wall of Skulls | Source
canonical_url: https://medium.com/@brennanbrown/afterwards-24b7e2285f54
medium_id: 24b7e2285f54
id: 145
guid: https://lastremark.wordpress.com/2016/04/21/afterwards/
---

> [When I die, delete my browser history.](http://www.incrediblethings.com/style-and-gear/delete-my-browser-history-medicalert-bracelet/)  
> — Anonymous

As it stands, the large majority of the internet — and services that operated based on it — run under some contradictory principles. On one hand, everything you use is rather fragile —domains expire all the time, and we live in a world full of budding start-ups that could be bought or [fail at any time](https://www.cbinsights.com/blog/startup-failure-post-mortem/). On the other, these companies operate as though they — and their users — are immortal.

This is pretty understandable. The largest demographic of the internet are [younger people (ages 15–34)](http://www.statista.com/statistics/272365/age-distribution-of-internet-users-worldwide/), and these businesses have to clearly rely on their users being alive to gain activity and make money.
...
![](https://cdn-images-1.medium.com/max/800/1*EE-NzT5kY91QVr6_vHNT3g.jpeg)

Démo Satosphère | [Source](https://vimeo.com/88389992)

It’s almost impossible for us to actually know what will happen to our data a decade from now — much less a century or a millennium. No matter how many redundant back-ups we might have, our hard drives will inevitably fail or will become incompatible and obsolete. (Although there is speculation of a [vast improvement](http://www.popularmechanics.com/technology/a19459/is-a-quartz-hard-drive-the-first-immortal-storage-medium/).)
...
And that‘s most troubling problem, here. Very few companies enable any sort of ‘legacy mode’ for their users. [Facebook does](http://time.com/3706807/facebook-death-legacy/), but only out of essentiality. [Penzu](http://help.penzu.com/legacy/how-does-penzu-legacy-work/) does as well, but only in their older version.
