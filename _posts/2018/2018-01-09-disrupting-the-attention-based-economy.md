...
subtitle: Stop being easily swayed by anything that’s in front of you. Start living
  a value-based lifestyle.
date: '2018-01-09T01:23:59.903Z'
...
- Productivity
- Technology
image: https://cdn-images-1.medium.com/max/2560/1*wm509xrohy46UG3caEwsWQ.png
image_caption: New Office | Source
canonical_url: https://medium.com/@brennanbrown/disrupting-the-attention-based-economy-e53182b37b75
medium_id: e53182b37b75
id: 90
...
We live in an [**attention-based economy**](https://techcrunch.com/2017/07/30/the-attention-economy-created-by-silicon-valley-is-bankrupting-us/). Companies and people can only sell you products and services if they first have your attention, after all. This is nothing new, but with the rise of clever marketing statics (ex. Data-collection, branded content, personalized advertisements, etc.) most people are often being sold things without even realizing it.

By way of technology, there have been [privacy tools and blockers](https://www.privacytools.io/) created as a way to negate these tactics. However, this is a band-aid solution to a deeper, fundamental problem of society.
...
What does this mean, exactly? Start with the fundamentals — what do you value in life? [What is your self-imposed purpose?](https://www.success.com/article/how-to-write-your-personal-mission-statement) These are not easy questions to answer, but again, they’re not impossible. Often times, exactly because of the everyday distractions and white noise that nags at us, we find ourselves too busy to stop and think about these kinds of questions.
...
![](https://cdn-images-1.medium.com/max/1200/1*0rrraKR-9n9PmtrtsDemYg.png)

---

There is beauty in getting used to the uncomfortable. People [constantly search out entertainment](https://www.theguardian.com/media/2017/feb/02/amusing-ourselves-to-death-neil-postman-trump-orwell-huxley) simply because we’ve become so unused to [boredom and being bored](https://www.npr.org/sections/alltechconsidered/2015/01/12/376717870/bored-and-brilliant-a-challenge-to-disconnect-from-your-phone). The modern mind is restless and uneasy — always looking for a distraction — and this is explicitly why the attention-based economy has been able to do so well.

In all honesty, this approach to life is far more difficult. The human brain is designed to sleepwalk into habits and routines and to tread the path of least resistance. Mindfulness needs to be developed, as well as gratitude — we’re conditioned to think we don’t have enough and need to seek out more — even though we most often [already have everything that we need](https://markmanson.net/everything-you-need).
...
[![](https://cdn-images-1.medium.com/max/800/1*pRon9UAtEO-JzTY-7mg1jA.png)](https://medium.com/@brennanbrown)
